...
func ProvisionThing(c mqtt.Client, keyPair KeyPair, awsEndpoint, templateName string, thingParameters map[string]string, certificateOutputPath string) error {
